...
test('shopping/todo/event spreadsheet export round-trips without recreating items', () => {
  ...
  assert.deepEqual(todosSheet!.data[0].slice(40), ["Hide_From_Calendar", "Is_Routine", "Routine_Interval", "Routine_Days_Of_Week", "Routine_Days_Of_Month", "Routine_Months_Of_Year", "Recurrence_Days", "Last_Generated_History_ID", "Skill_ID", "Skill_Name", "Skill_Routine_ID", "Duration_Minutes"]);
  ...
  assert.deepEqual(savingGoalsInvestmentsSheet!.data[0], ["Kind", "Status", "Name", "Target_Amount", "Saved_Amount", "Dedicated_Wallet_ID", "Due_Date", "Created_At", "Completed_At", "Tags", "Image_URL", "Hide_From_Calendar", "Investment_Type", "Investment_Code", "Investment_Units", "Investment_Avg_Buy", "Investment_Current_Price", "Investment_Platform", "ID"]);
