...
const outDir = path.join(root, 'docs', 'ndz-012-screenshots');
await mkdir(outDir, { recursive: true });

const userDataDir = '/tmp/ndz012-chrome-profile';
...
const db = {
  data: [
    item('t1', 'TODO', 'Verify NDZ-012 desktop composer alignment', 'pending', 0, { date: today, priority: 'high', tags: ['ndz','desktop'] }),
    item('t2', 'TODO', 'Check bottom overlap on Plan and Money', 'pending', 0, { date: today, priority: 'normal', tags: ['qa'] }),
    ...
    item('n1', 'NOTE', 'Composer should align with the active desktop surface.', 'done', -1, { tags: ['layout'] }),
    item('n2', 'NOTE', 'Plan and Money actions need safe bottom clearance.', 'done', -1, { tags: ['library'] }),
