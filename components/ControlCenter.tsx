                                            ...
                                            <section>
                                                    ...
                                                    <div className="bg-background border border-border rounded-2xl p-4 space-y-4">
                                                        <div className="text-xs text-muted bg-surface border border-border rounded-xl p-3 leading-relaxed">
                                                            Share your spreadsheet with <span className="font-mono text-primary">openclaw-adan@gen-lang-client-0558606321.iam.gserviceaccount.com</span> as Editor, paste the link here, then connect. OAuth Google sign-in has been removed; this app now uses service-account sync only.
                                                        </div>
                                                        <div>
                                                        ...
                                                        {!spreadsheetConfig && (
                                                            ...
                                                            >
                                                                {isConnectingSpreadsheet ? 'Checking access…' : 'Connect Spreadsheet'}
                                                            </button>
                                                        )}
                                                        {spreadsheetConfig && (
                                                            <button 
