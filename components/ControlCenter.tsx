...
const ControlCenter: React.FC<ControlCenterProps> = ({ 
    ...
    return (
        <>
            ...
            {/* Sheet */}
            <div className={`fixed bottom-0 left-0 right-0 bg-surface border-t border-border rounded-t-3xl z-[70] animate-in slide-in-from-bottom duration-300 shadow-2xl max-w-2xl mx-auto flex flex-col transition-all ${activeTab === 'main' ? 'h-auto max-h-[85vh]' : 'h-[85vh]'}`}>
