        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="absolute bottom-full left-0 right-0 mb-4 mx-4 md:mx-auto max-w-2xl lg:mx-0 lg:max-w-none bg-surface/90 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden flex flex-col z-50 pointer-events-auto h-[400px] max-h-[60vh]"
                >
                    {/* Controls */}
